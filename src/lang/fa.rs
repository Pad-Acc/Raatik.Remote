...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable keyboard/mouse", "کیبورد و ماوس — اجازه کنترل سیستم از راه دور"),
        ("Enable clipboard", "کلیپ‌بورد — اجازه کپی متن بین دو سیستم"),
        ...
        ("Enable file copy and paste", "کپی فایل — اجازه کپی و چسباندن فایل بین دو سیستم"),
        ("Connected", "متصل شده"),
        ...
        ("Enable remote restart", "ریستارت از راه دور — اجازه راه‌اندازی مجدد سیستم"),
        ...
        ("Enable audio", "صدا — پخش صدای سیستم میزبان برای پشتیبان"),
        ...
        ("Enable recording session", "ضبط جلسه — اجازه ذخیره تصویر جلسه"),
        ...
        ("Enable blocking user input", "مسدود کردن ورودی — پشتیبان می‌تواند کیبورد/ماوس محلی را قفل کند"),
        ...
        ("Enable privacy mode", "حالت حریم خصوصی — صفحه محلی را هنگام پشتیبانی مخفی می‌کند"),
