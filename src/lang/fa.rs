...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Start on boot", "شروع با ویندوز — اجرا هنگام روشن شدن سیستم"),
        ("Start the screen sharing service on boot, requires special permissions", "سرویس اشتراک صفحه را با روشن شدن ویندوز اجرا می‌کند؛ نیاز به مجوز ویژه دارد"),
