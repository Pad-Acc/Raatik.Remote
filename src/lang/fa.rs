...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "وضعیت"),
        ("Your Desktop", "آماده برای پشتیبانی اتوفای"),
        ("desk_tip", "شناسه این سیستم را برای پشتیبان بخوانید یا کپی کنید"),
        ("Password", "رمز عبور"),
        ("Ready", "آماده به کار"),
        ...
        ("Control Remote Desktop", "اتصال به سیستم دیگر"),
        ("Transfer file", "ارسال/دریافت فایل"),
        ("Connect", "اتصال"),
        ("Recent sessions", "جلسات اخیر"),
        ("Address book", "دفترچه آدرس"),
        ("Confirmation", "تایید"),
        ("TCP tunneling", "تونل TCP"),
        ("Remove", "حذف"),
        ("Refresh random password", "بروزرسانی رمز عبور تصادفی"),
        ("Set your own password", "رمز عبور دلخواه بگذارید"),
        ("Enable keyboard/mouse", "کیبورد و ماوس"),
        ("Enable clipboard", "کلیپ‌بورد"),
        ("Enable file transfer", "انتقال فایل — اجازه ارسال و دریافت فایل در جلسه"),
        ("Enable TCP tunneling", "تونل TCP — عبور ترافیک شبکه از طریق اتصال راه دور"),
        ("IP Whitelisting", "لیست IPهای مجاز"),
        ("My ID", "شناسه من"),
        ("Copy ID and password", "کپی شناسه و رمز"),
        ("For support team", "برای تیم پشتیبانی"),
        ("ID/Relay Server", "سرور شناسه و رله — آدرس سرور راتیک برای اتصال"),
        ...
        ("Hardware Codec", "کدک سخت‌افزاری — استفاده از پردازنده گرافیکی برای تصویر"),
        ("Adaptive bitrate", "نرخ بیت تطبیقی — کیفیت را خودکار با وضعیت اینترنت تنظیم می‌کند"),
        ("ID Server", "شناسه سرور"),
        ("Relay Server", "سرور Relay"),
        ("API Server", "سرور API"),
        ("invalid_http", "باید با http:// یا https:// شروع شود"),
        ("Invalid IP", "آدرس IP نامعتبر است"),
        ...
        ("Connected, waiting for image...", "ارتباط برقرار شد، در انتظار تصویر..."),
        ("Name", "نام"),
        ("Type", "نوع فایل"),
        ...
        ("Good image quality", "کیفیت بالا — تصویر واضح‌تر؛ در اینترنت ضعیف ممکن است کند شود"),
        ("Balanced", "متعادل — تعادل بین وضوح و سرعت"),
        ("Optimize reaction time", "سرعت بالا — واکنش سریع‌تر در اینترنت ضعیف؛ تصویر ساده‌تر"),
        ("Custom", "سفارشی — انتخاب دستی"),
        ("Show remote cursor", "نشانگر راه دور — دیدن مکان‌نمای سیستم مقابل"),
        ("Show quality monitor", "نمایشگر کیفیت — آمار FPS و تأخیر روی صفحه"),
        ("Disable clipboard", "غیرفعال‌سازی کلیپ‌بورد — جلوگیری از کپی بین دو طرف"),
        ("Lock after session end", "قفل پس از پایان جلسه — صفحه قفل می‌شود وقتی اتصال قطع شد"),
        ("Insert Ctrl + Alt + Del", "کنترل ویندوز"),
        ...
        ("Failed to connect to relay server", "اتصال به سرور Relay انجام نشد"),
        ("Failed to connect via rendezvous server", "اتصال از طریق سرور تولید شناسه انجام نشد"),
        ("Failed to connect via relay server", "اتصال از طریق سرور Relay انجام نشد"),
        ...
        ("install_tip", "به دلیل UAC، در برخی موارد RustDesk به‌عنوان سمت کنترل‌شونده درست کار نمی‌کند. برای جلوگیری از UAC، روی دکمه زیر کلیک کنید تا RustDesk در سیستم نصب شود."),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "برای کنترل از راه دور دسکتاپ، باید مجوز Accessibility را به RustDesk بدهید."),
        ("config_screen", "برای دسترسی از راه دور به دسکتاپ، باید مجوز Screen Recording را به RustDesk بدهید."),
        ("Installing ...", "در حال نصب..."),
        ("Install", "نصب"),
        ("Installation", "نصب و راه اندازی"),
        ("Installation Path", "محل نصب"),
        ("Create start menu shortcuts", "ایجاد میانبرها در منوی Start"),
        ...
        ("Permissions", "دسترسی‌ها — چه کارهایی پشتیبان مجاز است انجام دهد"),
        ("Accept", "پذیرفتن"),
        ("Dismiss", "رد کردن"),
        ("Disconnect", "پایان جلسه"),
        ("Enable file copy and paste", "کپی فایل"),
        ("Connected", "متصل شده"),
        ("Direct and encrypted connection", "اتصال مستقیم و رمزگذاری شده"),
        ("Relayed and encrypted connection", "اتصال از طریق Relay و رمزگذاری شده"),
        ("Direct and unencrypted connection", "اتصال مستقیم و بدون رمزگذاری"),
        ("Relayed and unencrypted connection", "اتصال از طریق Relay و بدون رمزگذاری"),
        ...
        ("Enable remote configuration modification", "تغییر پیکربندی از راه دور — اجازه ویرایش تنظیمات توسط پشتیبان"),
        ("Run without install", "بدون نصب اجرا شود"),
        ("Connect via relay", "اتصال با رله"),
        ("Always connect via relay", "همیشه از طریق Relay متصل شو"),
        ("whitelist_tip", "فقط IPهای مجاز می‌توانند به این سیستم وصل شوند"),
        ("Login", "ورود"),
        ("Verify", "تأیید کنید"),
        ...
        ("Socks5/Http(s) Proxy", "پروکسی Socks5/HTTP(s) — اتصال از طریق پروکسی شبکه"),
        ("Discovered", "پیدا شده"),
        ...
        ("android_input_permission_tip1", "برای اینکه یک دستگاه از راه دور بتواند دستگاه Android شما را با ماوس یا لمس کنترل کند، باید به RustDesk اجازه استفاده از سرویس Accessibility را بدهید."),
        ("android_input_permission_tip2", "به صفحه تنظیمات بعدی بروید، [Installed Services] را پیدا کنید و سرویس [RustDesk Input] را روشن کنید."),
        ...
        ("android_start_service_tip", "برای شروع سرویس اشتراک‌گذاری صفحه، روی [Start service] بزنید یا مجوز [Screen Capture] را فعال کنید."),
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان رابط"),
        ("Keep RustDesk background service", "سرویس پس‌زمینه RustDesk را نگه دارید"),
        ...
        ("Start on boot", "شروع با روشن شدن دستگاه — اجرا هنگام بالا آمدن سیستم"),
        ("Start the screen sharing service on boot, requires special permissions", "سرویس اشتراک صفحه را با روشن شدن دستگاه اجرا می‌کند؛ نیاز به مجوز ویژه دارد"),
        ("Connection not allowed", "اتصال مجاز نیست"),
        ("Legacy mode", "حالت legacy"),
        ("Map mode", "حالت map"),
        ("Translate mode", "حالت ترجمه"),
        ("Use permanent password", "رمز دائمی — همیشه با همین رمز وصل شوید"),
        ("Use both passwords", "هر دو رمز — هم یک‌بارمصرف و هم دائمی پذیرفته می‌شود"),
        ("Set permanent password", "یک رمز عبور دائمی تنظیم شود"),
        ("Enable remote restart", "ریستارت از راه دور"),
        ...
        ("Control Actions", "ارسال فایل و کنترل"),
        ("Display Settings", "کنترل صفحه"),
        ("Ratio", "نسبت"),
        ("Image Quality", "کیفیت تصویر — واضح‌تر در اینترنت قوی، سریع‌تر در اینترنت ضعیف"),
        ("Scroll Style", "سبک اسکرول"),
        ("Show Toolbar", "نمایش نوار ابزار"),
        ("Hide Toolbar", "پنهان کردن نوار ابزار"),
        ("Direct Connection", "ارتباط مستقیم"),
        ("Relay Connection", "ارتباط Relay"),
        ("Secure Connection", "ارتباط امن"),
        ("Insecure Connection", "ارتباط غیر امن"),
        ("Continue", "ادامه"),
        ("Scale original", "اندازه اصلی — بدون تغییر مقیاس صفحه راه دور"),
        ("Scale adaptive", "مقیاس تطبیقی — جا شدن صفحه در پنجره شما"),
        ("General", "عمومی و ظاهر"),
        ("Security", "امنیت و دسترسی"),
        ("Theme", "ظاهر — روشن یا تیره"),
        ("Dark Theme", "نمایه تیره"),
        ("Light Theme", "نمایه روشن"),
        ("Dark", "تیره"),
        ("Light", "روشن"),
        ("Follow System", "پیروی از سیستم"),
        ("Enable hardware codec", "کدک سخت‌افزاری — رمزگشایی سریع‌تر با کارت گرافیک"),
        ("Unlock Security Settings", "باز کردن تنظیمات امنیتی"),
        ("Enable audio", "صدا"),
        ("Unlock Network Settings", "باز کردن تنظیمات شبکه"),
        ("Server", "سرور"),
        ("Direct IP Access", "دسترسی مستقیم با IP — اتصال بدون سرور شناسه"),
        ("Proxy", "پروکسی"),
        ("Apply", "اعمال تغییرات"),
        ("Disconnect all devices?", "همه دستگاه ها قطع شوند؟"),
        ("Clear", "پاک کردن"),
        ("Audio Input Device", "منبع صدا"),
        ("Use IP Whitelisting", "لیست IP مجاز — فقط آدرس‌های مشخص‌شده وصل می‌شوند"),
        ("Network", "شبکه و سرور راتیک"),
        ...
        ("Other", "سایر"),
        ("Confirm before closing multiple tabs", "تأیید قبل از بستن چند زبانه"),
        ("Keyboard Settings", "تنظیمات صفحه کلید"),
        ("Full Access", "دسترسی کامل — کنترل و همه مجوزها"),
        ("Screen Share", "اشتراک صفحه — فقط مشاهده بدون کنترل"),
        ("ubuntu-21-04-required", "Wayland نیازمند اوبونتو نسخه 21.04 یا بالاتر است"),
        ("wayland-requires-higher-linux-version", "Wayland نیازمند نسخه بالاتری از توزیع لینوکس است. لطفاً از دسکتاپ X11 استفاده کنید یا سیستم‌عامل خود را ارتقا دهید"),
        ...
        ("Show RustDesk", "نمایش RustDesk"),
        ("This PC", "This PC"),
        ("or", "یا"),
        ("Elevate", "ارتقاء"),
        ("Zoom cursor", "بزرگ‌نمایی نشانگر — دیدن آسان‌تر مکان‌نما"),
        ("Accept sessions via password", "پذیرش با رمز — اتصال فقط پس از وارد کردن رمز"),
        ("Accept sessions via click", "پذیرش با کلیک — باید اتصال را دستی تأیید کنید"),
        ("Accept sessions via both", "هر دو روش — رمز یا تأیید دستی"),
        ...
        ("Use one-time password", "رمز یک‌بارمصرف — هر بار رمز جدید روی صفحه اصلی"),
        ("One-time password length", "طول رمز عبور یکبار مصرف"),
        ("Request access to your device", "دسترسی به دستگاه خود را درخواست کنید"),
        ("Hide connection management window", "پنهان‌سازی پنجره مدیریت اتصال — پنجره اتصالات ورودی دیده نشود"),
        ("hide_cm_tip", "فقط وقتی پذیرش با رمز دائمی باشد می‌توان این پنجره را پنهان کرد"),
        ...
        ("Always use software rendering", "رندر نرم‌افزاری — اگر پنجره راه دور بلافاصله بسته شد امتحان کنید"),
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه‌کلید، باید مجوز Input Monitoring را به RustDesk بدهید."),
        ("config_microphone", "برای صحبت از راه دور، باید مجوز Record Audio را به RustDesk بدهید."),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور باید روی OK در پنجره UAC مربوط به اجرای RustDesk کلیک کند."),
        ...
        ("Display", "نمایش و کیفیت تصویر"),
        ("Default View Style", "سبک نمایش پیش‌فرض"),
        ("Default Scroll Style", "سبک اسکرول پیش‌فرض"),
        ("Default Image Quality", "کیفیت تصویر پیش‌فرض — واضح‌تر در اینترنت قوی، سریع‌تر در اینترنت ضعیف"),
        ("Default Codec", "کدک پیش‌فرض — روش فشرده‌سازی تصویر"),
        ("Bitrate", "میزان بیت صفحه نمایش"),
        ("FPS", "فریم در ثانیه"),
        ("Auto", "خودکار"),
        ("Other Default Options", "سایر گزینه‌های پیش‌فرض جلسه"),
        ...
        ("show_monitors_tip", "نمایش مانیتورها در نوار ابزار — تعویض سریع نمایشگر"),
        ("View Mode", "فقط مشاهده — بدون کنترل کیبورد و ماوس"),
        ...
        ("xorg_not_found_title_tip", "Xorg پیدا نشد"),
        ...
        ("Collapse toolbar", "جمع کردن نوار ابزار — نوار ابزار جلسه جمع شود"),
        ("Accept and Elevate", "بپذیرید و افزایش دهید"),
        ("accept_and_elevate_btn_tooltip", "اتصال را بپذیرید و مجوزهای UAC را افزایش دهید."),
        ...
        ("Open connection in new tab", "اتصال در زبانه جدید"),
        ...
        ("Reverse mouse wheel", "معکوس کردن چرخ ماوس"),
        ("{} sessions", "{} جلسه"),
        ("scam_title", "ممکن است شما در حال کلاهبرداری باشید!"),
        ("scam_text1", "اگر با شخصی که نمی‌شناسید و به او اعتماد ندارید صحبت می‌کنید و از شما خواسته است از RustDesk استفاده کنید و سرویس را راه‌اندازی کنید، ادامه ندهید و بلافاصله تلفن را قطع کنید."),
        ...
        ("auto_disconnect_option_tip", "قطع خودکار — جلسه ورودی در صورت بی‌فعالیتی بسته می‌شود"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "لطفاً RustDesk Server Pro را به نسخه {} یا جدیدتر ارتقا دهید"),
        ("pull_group_failed_tip", "گروه بازخوانی نشد"),
        ("Filter by intersection", "فیلتر بر اساس اشتراک"),
        ("Remove wallpaper during incoming sessions", "حذف پس‌زمینه در جلسه — تصویر سبک‌تر برای اینترنت ضعیف"),
        ("Test", "تست"),
        ...
        ("selinux_tip", "SELinux روی دستگاه شما فعال است و ممکن است از اجرای صحیح RustDesk به‌عنوان سمت کنترل‌شونده جلوگیری کند."),
        ...
        ("True color (4:4:4)", "رنگ واقعی 4:4:4 — رنگ دقیق‌تر؛ پهنای باند بیشتر"),
        ("Enable blocking user input", "مسدود کردن ورودی"),
        ...
        ("swap-left-right-mouse", "جابه‌جایی چپ/راست ماوس"),
        ("2FA code", "کد ورود 2 مرحله ای"),
        ("More", "بیشتر"),
        ("enable-2fa-title", "فعال‌سازی 2FA — لایه امنیتی اضافه با کد یک‌بارمصرف"),
        ("enable-2fa-desc", "لطفاً هم اکنون برنامه تأییدکننده خود را تنظیم کنید. می‌توانید از برنامه‌ای مانند Authy، Microsoft یا Google Authenticator روی تلفن همراه یا دسکتاپ استفاده کنید.\n\nبارکد QR را با برنامه اسکن کنید و کد نمایش‌داده‌شده را وارد کنید تا احراز هویت دو مرحله‌ای فعال شود."),
        ...
        ("allow-only-conn-window-open-tip", "فقط وقتی برنامه باز است — اگر پنجره بسته باشد اتصال پذیرفته نمی‌شود"),
        ("no_need_privacy_mode_no_physical_displays_tip", "بدون نمایشگر فیزیکی نیازی به استفاده از حالت خصوصی نیست"),
        ("Follow remote cursor", "دنبال‌کردن نشانگر راه دور — نما به مکان‌نمای مقابل حرکت کند"),
        ("Follow remote window focus", "دنبال‌کردن فوکوس پنجره — نما روی پنجره فعال مقابل"),
        ("default_proxy_tip", "پروتکل پیش‌فرض Socks5 و پورت 1080 است"),
        ...
        ("confirm_clear_Wayland_screen_selection_tip", "آیا مطمئن هستید که انتخاب صفحه Wayland را پاک می‌کنید؟"),
        ...
        ("Use texture rendering", "رندر بافت — تصویر نرم‌تر؛ در مشکل نمایش خاموش کنید"),
        ("Floating window", "پنجره شناور"),
        ("floating_window_tip", "این گزینه به حفظ سرویس پس‌زمینه RustDesk کمک می‌کند"),
        ("Keep screen on", "صفحه نمایش را روشن نگه دارید"),
        ("Never", "هرگز"),
        ("During controlled", "در حین کنترل"),
        ("During service is on", "در حین سرویس روشن است"),
        ("Capture screen using DirectX", "ضبط صفحه با DirectX — روش جایگزین ضبط در ویندوز"),
        ("Back", "برگشت"),
        ("Apps", "برنامه ها"),
        ...
        ("About RustDesk", "درباره RaatikDesk"),
        ...
        ("Enable trusted devices", "دستگاه‌های مورد اعتماد — بدون 2FA دوباره برای دستگاه‌های ذخیره‌شده"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "لطفاً کلاینت RustDesk را در سمت راه دور به نسخه {} یا جدیدتر ارتقا دهید"),
        ("d3d_render_tip", "فعال کردن رندر D3D برای عملکرد بهتر"),
        ("Use D3D rendering", "رندر D3D — عملکرد بهتر در ویندوز"),
        ("Printer", "چاپگر"),
        ...
        ("websocket_tip", "هنگام استفاده از WebSocket، فقط اتصالات رله پشتیبانی می‌شوند."),
        ...
        ("Terminal", "ترمینال"),
        ("Enable terminal", "ترمینال — اجازه اجرای خط فرمان از راه دور"),
        ("New tab", "زبانه جدید"),
        ...
        ("elevation_username_tip", "نام کاربری را به صورت username یا domain\\username وارد نمایید"),
        ...
        ("Allow insecure TLS fallback", "بازگشت TLS ناامن — فقط اگر گواهی سرور تأیید نشود"),
        ...
        ("Disable UDP", "فقط TCP — به‌جای UDP از TCP استفاده شود"),
        ...
        ("keep-awake-during-outgoing-sessions-label", "بیدار ماندن صفحه در جلسات خروجی — جلوگیری از خواب سیستم هنگام پشتیبانی"),
        ("keep-awake-during-incoming-sessions-label", "بیدار ماندن صفحه در جلسات ورودی — جلوگیری از خواب سیستم"),
        ...
        ("Enable privacy mode", "حالت حریم خصوصی"),
        ("allow-remote-toolbar-docking-any-edge", "لنگر نوار ابزار به هر لبه — جابه‌جایی نوار ابزار جلسه"),
        ("API Token", "توکن API"),
        ("Deploy", "استقرار"),
        ...
        ("Show monitor switch button on the main toolbar", "دکمه تعویض نمایشگر در نوار ابزار"),
