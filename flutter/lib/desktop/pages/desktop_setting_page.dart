...
class _SafetyState extends State<_Safety> with AutomaticKeepAliveClientMixin {
  ...
  Widget tfa() {
    ...
    tmpWrapper() {
      ...
      final tfa = Padding(
        padding: EdgeInsetsDirectional.only(start: _kCheckBoxLeftMargin),
        child: GestureDetector(
        child: InkWell(
          child: Obx(() => Row(
                children: [
      ...
      final bot = Padding(
        padding: EdgeInsetsDirectional.only(start: _kCheckBoxLeftMargin + 30),
        child: GestureDetector(
        child: Tooltip(
    ...
    return ChangeNotifierProvider.value(
        ...
        child: Consumer<ServerModel>(builder: ((context, model, child) {
          ...
          final numericOneTimePassword = Padding(
            padding: EdgeInsetsDirectional.only(start: _kContentHSubMargin - 5),
            child: GestureDetector(
            child: InkWell(
                child: Row(
              children: [
...
class __PrinterState extends State<_Printer> {
  ...
  Widget outgoing(BuildContext context) {
    ...
    Widget tipPrinterNotInstalled() {
      ...
      return Padding(
        padding: EdgeInsetsDirectional.only(start: _kCardLeftMargin, bottom: 2.0),
        child: Column(children: [
        Obx(
        ...
        child: _Card(title: translate('About RustDesk'), children: [
          Padding(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://raatik.com/privacy');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://raatik.com');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Copyright © ${DateTime.now().toString().substring(0, 4)} Rayan Etemad Tosee Yekta (RAATIK)\n$license',
...
Widget _SubButton(String label, Function() onPressed, [bool enabled = true]) {
  return Padding(
    padding: EdgeInsetsDirectional.only(start: _kContentHSubMargin),
    child: Row(
    children: [
      ElevatedButton(
        onPressed: enabled ? onPressed : null,
